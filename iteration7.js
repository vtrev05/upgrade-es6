...
let examsReducer = exams.reduce((acc, exam) => {
...
let examsApproved = exams.reduce((acc, exam) => {
...
let examsReducerProm = exams.reduce((acc, exam) => {
      return (acc += exam.score);
    
}, 0)
let prom = examsReducerProm / exams.length
console.log(prom)